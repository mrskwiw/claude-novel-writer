...
1. `novel/COMPOSITIONAL_STYLE_GUIDE.md` - Voice, POV, themes, imagery, narrative rules
2. `novel/STRUCTURAL_STYLE_GUIDE.md` - Technical patterns, pacing markers
...
**ALWAYS consult novel/COMPOSITIONAL_STYLE_GUIDE.md before developmental editing.**
